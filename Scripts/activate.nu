...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Prathamesh\PycharmProjects\Django_Import_Excel_Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Prathamesh\PycharmProjects\Django_Import_Excel_Project\venv\Scripts\deactivate.nu'
